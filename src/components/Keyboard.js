...
const colorsD = {
  colorBlind1:["#882255", "#AA4499", "#CC6677", "#DDCC77", "#88CCEE", "#44AA99", "#117733","#4035FF", "#A8B8EF", "#332288", "#9BB34D", "#D3F3B8"],
  colorBlind2:["#920000", "#924900", "#db6d00", "#24ff24", "#ffff6d", "#ff6db6", "#ffb6db", "#490092", "#006ddb", "#b66dff","#6db6ff", "#b6dbff"],//"#009292"
  ...
  other:      ["#cd0223", "#d45331", "#e39255", "#ecbb10", "#e3d98a", "#47e643", "#28cbb9", "#049496", "#2f7ecc", "#674ed8", "#a059ed", "#ba04ff"]
};
  ...
  handleKeyDown = (e) => {
    ...
    if (
      ...
      if (e.code === "KeyE") {
        ...
        this.playNote(activeScale.NoteNameWithOctaveNumber(octave+octaveDist,distToCurrentOctave,StepsAboveRoot));             
      }
      if (e.code === "KeyW") {
  ...
  handleKeyUp = (e) => {
    ...
    if (
      ...
      if (e.code === "KeyE") {
        const StepsAboveRoot = 2;//root==0, 2 selects the third tone in the scale
        const distToCurrentOctave = 0;
        this.releaseNote(activeScale.NoteNameWithOctaveNumber(octave+octaveDist,distToCurrentOctave,StepsAboveRoot));             
      }
      if (e.code === "KeyW") {
        const StepsAboveRoot = 1;//root==0, 2 selects the third tone in the scale
        const distToCurrentOctave = 0;
