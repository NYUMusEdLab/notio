const tooltipText = {
    ...
    "extendKeyboard": "Extend Keyboard <br/> Toggles the keyboard between only showing 1 octave and the 3 extra notes surrounding the octave on top and bottom <br/>",
