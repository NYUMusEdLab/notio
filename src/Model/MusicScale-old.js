...
//     this.ResetNext();
//     this.Notations.forEach(notation => this.NextIndex[notation]= 0)
//   }
...
//   Next(notation){
//     let result 
//     if(notations.includes(notation)){
//       result = this.ExtendedScaleToneNames[notation][this.NextIndex[notation]];
//       this.NextIndex[notation] = this.NextIndex[notation] + 1;

//     }
//     else{
//       result = this.Current("English");
//       console.log("looked for nonexistant notation in MusicScale:", notation)
//     }
//     return result;
//   }
...
//     }
//     catch{
//       console.log("requested a nonexisting notation from MusicScale")
//       result = this.ExtendedScaleToneNames["ColorKeys"][this.NextIndex["ColorKeys"]];
//     }
//     return result;
//   }
...
//     theScale["ColorKeys"] = [...theScale["English"]];
//     return theScale;
//   }
